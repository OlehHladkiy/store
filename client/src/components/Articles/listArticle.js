...
const ListArticle = (props) => {
      ...
      return (
            <div className="list-article" onClick={() => update()}>
                  <div className="list-article-section list-article-image" style={{
                        background: `url(${images[0].url}) center no-repeat`,
                        backgroundSize: '20%'
                  }}></div>
                  <div className="list-article-section list-article-name">
                        {name}
                  </div>
                  <div className="list-article-section list-item-brand">
                        {brand.name}
                  </div>
                  ...
                  <div className="article-action-section list-article-section">
                        <FontAwesomeIcon className="action-icon" icon={faTrash} onClick={(e) => {e.stopPropagation(); props.removeArticle(props._id, previousData )}}/>
                  </div>
            </div>
      )
}
...
export default connect(null, {removeArticle})(ListArticle);
