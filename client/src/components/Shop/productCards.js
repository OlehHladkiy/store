...
const ProductCard = (props) => {
    return (
        <div className="card" onClick={() => props.history.push(`/article_detail/${props.article._id}`)}>
                <div className="card-image-container" style={{
                    background: `url(${props.article.images[0] ? props.article.images[0].url : "https://www.losriosriverrunners.com/uploads/thumb_image_not_available.png"}) center no-repeat`,
                    backgroundSize: 'auto'
                }}>
                </div>
