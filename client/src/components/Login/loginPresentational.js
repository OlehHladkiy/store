        ...
        <div className="new-customers">
          <div className="customers-container">
            ...
            <p>
              ...
              ea iste modi optio praesentium quidem soluta voluptatem. Eaque
              iusto non officia provident quam quis rerum vel, vero voluptate
              voluptatem. Autem.
            </p>
            <MyButton linkTo={"/register"} text="Create new account" />
          </div>
        </div>
