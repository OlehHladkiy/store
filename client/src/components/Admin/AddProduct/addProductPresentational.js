    ...
    <UserLayout {...props}>
        ...
        <div className="add-product-container">
          ...
          <div className="add-product-form-container">
            <form className="login-form" onSubmit={onSubmit}>
                ...
                <div className="add-atribute-container">
                  {formData.packingAndPrice.addedValues.map(item => (
                    <div key={item._id} className="add-atribute">
                      ...
                      <FontAwesomeIcon
                        onClick={() =>
                          deleteAtribute(item._id, "packingAndPrice")
                        }
                        icon={faPlus}
                        className="icon-delete-atribute"
                      />
              ...
              <div className="add-atributes">
                <FormField
                  formData={formData.packingAndPrice}
                  change={updateForm}
                />
                <button
                  onClick={props.handleDialogOpen}
                  disabled={formData.packingAndPrice.value === ""}
                  type="button"
                  className="plus-icon-button"
                >
                  <FontAwesomeIcon icon={faPlus} />
              ...
              {formError ? (
                <div className="error-message">
                  {props.errorMessageAddProduct
                    ? props.errorMessageAddProduct
                    : "wrong data!"}
                </div>
              ) : null}
              {formSuccess ? <div className="success">Success</div> : null}
            </form>
          </div>
        </div>
      </div>
      <Dialog open={props.openDialog} onClose={props.handleDialogClose}>
        ...
        <div className="dialog-actions">
          <button
            type="button"
            disabled={formData.price.value === ""}
            className="button"
            onClick={() => props.pushAtribute("packingAndPrice", true)}
          >
            Ok
          </button>
          <button
