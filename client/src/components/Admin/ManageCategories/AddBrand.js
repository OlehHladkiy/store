...
import {
  ...
  addBrand,
  updateBrand
} from "../../../action/categories_actions";
...
class AddBrand extends Component {
  ...
  renderList = list => {
    return list.map(list => (
      <div
        className="list-item"
        onClick={() => this.handleOpenDialogUpdate(list._id)}
        key={list._id}
        onMouseEnter={() => this.setState({ mouseOverTarget: list._id })}
        onMouseLeave={() => this.setState({ mouseOverTarget: "" })}
      >
        {list.name}
      ...
      <div className="add-block">
        <div className="items-container">
          <div
            ...
            onClick={() => this.handleOpenDialogNewItem()}
          >
        ...
        <UpdateDialog
          type="brand"
          nameOfButton="Save"
          action={(dataToSubmit, previousData, id) =>
            this.props.updateBrand(dataToSubmit, previousData, id)
          }
        ...
        <UpdateDialog
          type="brand"
          nameOfButton="Add"
          action={(dataToSubmit, previousData) =>
            this.props.addBrand(dataToSubmit, previousData)
          }
          data={this.props.brands}
...
export default connect(
  mapStateToProps,
  { getBrands, deleteBrand, addBrand, updateBrand }
)(AddBrand);
